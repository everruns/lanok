"""Tests for validate_okf.py.

The validator is a standard-library script shared with the sibling Everruns
repositories; keep changes portable rather than lanok-specific, and port fixes
both ways. Yolop's copy carries one extra test asserting it matches a bundled
system skill, which lanok has no equivalent of.
"""
