#!/bin/sh
# Install the Lanok agent skill into a Claude Code skills directory.
#
# The skill's one home is skills/lanok/ in this repo; this script copies it into a
# Claude Code skills root so an agent can build protocols with lanok. It works two
# ways with no embedding and no extra dependency:
#
#   - From a checkout (this script sits next to skills/lanok/): copies locally.
...
#   curl -fsSL https://raw.githubusercontent.com/everruns/lanok/main/skills.sh | sh
#   curl -fsSL https://raw.githubusercontent.com/everruns/lanok/main/skills.sh | sh -s -- --global
#
...
REPO="everruns/lanok"
SKILL="lanok"
# The files that make up the skill. Keep in sync with skills/lanok/.
FILES="SKILL.md references/cookbook.md references/wire.md"
